		...
		<div class="container-fluid login-container">
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Inicio de sesion</h3>
		</div>
			...
			{/if}
												...
												<div class="control-group">
													<label class="control-label" for="username"><b>Usuario</b></label>
													<div class="controls">
			...
			<div class="control-group">
													<label class="control-label" for="password"><b>Clave</b></label>
				<div class="controls">
												...
												<div class="control-group signin-button">
													<div class="controls" id="forgotPassword">
														<button type="submit" class="btn btn-primary sbutton">Ingresar</button>
														&nbsp;&nbsp;&nbsp;<a></a>
													</div>
												</div>
